...
const categories = [
  ...
  { id: 5, name: "Art & Paintings" },
  { id: 6, name: "For Children" },
  { id: 7, name: "Clothes" },
  { id: 8, name: "Building Materials" },
  { id: 9, name: "Other" },
];
        ...
        <div className="relative max-w-xl mx-auto">
          ...
          <div className="mt-12r">
            ...
            >
              ...
              <div className="sm:flex sm:gap-4 sm:justify-center">
                <div className="mt-1 sm:mt-0 sm:col-span-2">
                  ...
                  <p className="mt-2 text-sm text-gray-500">
                    Write a few sentences about this item. (contidtion and etc.)
                  </p>
                </div>
              </div>
